    ...
    res1.get().then((docSnapshot) => {
      if (docSnapshot.exists) {
        var snapshot1 = res1.onSnapshot((doc) => {
          ...
          newObj = [
            itemID,
            doc.data().candidate1_name,
            doc.data().candidate2_name,
            doc.data().candidate3_name,
            doc.data().candidate4_name,
            doc.data().candidate5_name,
            doc.data().candidate1_resume,
            doc.data().candidate2_resume,
            doc.data().candidate3_resume,
            doc.data().candidate4_resume,
            doc.data().candidate5_resume,
            doc.data().candidate1_headshot,
            doc.data().candidate2_headshot,
            doc.data().candidate3_headshot,
            doc.data().candidate4_headshot,
            doc.data().candidate5_headshot,
          ];
          csvList = [...csvList, newObj];
        ...
        <div className="list">
          ...
          {this.state.adminVersion == "singleCSV" && (
            <div className="horizontal">
              <div>
                Activity Data Processed {this.state.completedActivity}/
                {this.state.totalActivity}
              </div>
          ...
          {this.state.adminVersion == "singleCSV" && (
            <div className="horizontal">
              <div>
                Resume Data Processed {this.state.completedResume}/
                {this.state.totalResume}
              </div>
